...
public class DatabaseHandler extends SQLiteOpenHelper {
    ...
    private Wishlist getWishlistByCursor(Cursor cur) {
        ...
        obj.product_id = cur.getLong(cur.getColumnIndexOrThrow(COL_WISH_PRODUCT_ID));
        obj.name = cur.getString(cur.getColumnIndexOrThrow(COL_WISH_NAME));
        obj.image = cur.getString(cur.getColumnIndexOrThrow(COL_WISH_IMAGE));
        obj.created_at = cur.getLong(cur.getColumnIndexOrThrow(COL_WISH_CREATED_AT));
        return obj;
    }
    ...
    private Cart getCartByCursor(Cursor cur) {
        Cart obj = new Cart();
        obj.id = cur.getLong(cur.getColumnIndexOrThrow(COL_CART_ID));
        obj.order_id = cur.getLong(cur.getColumnIndexOrThrow(COL_CART_ORDER_ID));
        obj.product_id = cur.getLong(cur.getColumnIndexOrThrow(COL_CART_PRODUCT_ID));
        obj.product_name = cur.getString(cur.getColumnIndexOrThrow(COL_CART_PRODUCT_NAME));
        obj.image = cur.getString(cur.getColumnIndexOrThrow(COL_CART_IMAGE));
        obj.amount = cur.getInt(cur.getColumnIndexOrThrow(COL_CART_AMOUNT));
        obj.stock = cur.getLong(cur.getColumnIndexOrThrow(COL_CART_STOCK));
        obj.price_item = cur.getDouble(cur.getColumnIndexOrThrow(COL_CART_PRICE_ITEM));
        obj.created_at = cur.getLong(cur.getColumnIndexOrThrow(COL_CART_CREATED_AT));
        return obj;
    }

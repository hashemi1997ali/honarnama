...
import ir.hashemi.market.ActivityNewsInfoDetails;
import ir.hashemi.market.R;
import ir.hashemi.market.adapter.AdapterFeaturedNews;
    ...
    private void displayResultData(List<NewsInfo> items) {
        ...
        adapter.setOnItemClickListener(new AdapterFeaturedNews.OnItemClickListener() {
            ...
            public void onItemClick(View view, NewsInfo obj) {
                ...
                ActivityNewsInfoDetails.navigate(getActivity(), obj.id);
            }
        });
